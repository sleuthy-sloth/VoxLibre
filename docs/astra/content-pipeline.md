...
The generated offline bundle contains the React runtime, schemas and learning logic; pack JSON is loaded separately. Inspect raw/gzip bundle sizes when adding dependencies. Foundation version 1.1.0 adds 32 locally generated Kokoro model recordings with committed transcripts, provenance and hashes. See `foundation-listening.md` for authoring and QA; human prosody review is still open. Asset provenance remains in `docs/audio-provenance/`.
